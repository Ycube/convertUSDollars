      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col s6">
            <ul>
              <li>
                <a className="btn-floating btn-large waves-effect waves-light red lighten-2" onClick={this.handleClick.bind(this, -1)}><i className="material-icons">-1</i></a>
              </li>
              <li>
                <a className="btn-floating btn-large waves-effect waves-light red lighten-2" onClick={this.handleClick.bind(this, -5)}><i className="material-icons">-5</i></a>
              </li>
              <li>
                <a className="btn-floating btn-large waves-effect waves-light red lighten-2" onClick={this.handleClick.bind(this, -10)}><i className="material-icons">-10</i></a>
              </li>
              <li>
                <a className="btn-floating btn-large waves-effect waves-light red lighten-2" onClick={this.handleClick.bind(this, -20)}><i className="material-icons">-20</i></a>
              </li>
              <li>
                <a className="btn-floating btn-large waves-effect waves-light red lighten-2" onClick={this.handleClick.bind(this, -100)}><i className="material-icons">-100</i></a>
              </li>
            </ul>
          </div>
          {/************Plus Buttons**************/}
